package com.fzc.lowcopyjiantalk.indicator;
...
public class CirclePageIndicator extends View implements PageIndicator {
	...
	private SplashViewPager.OnPageChangeListener mListener;
	...
	public void onPageSelected(int position) {
		if (mSnap || mScrollState == SplashViewPager.SCROLL_STATE_IDLE) {
			mCurrentPage = position;
			mSnapPage = position;
			invalidate();
		}
	...
	@Override
	public void setOnPageChangeListener(SplashViewPager.OnPageChangeListener listener) {
		mListener = listener;
	}
	...
	@Override
	public void setViewPager(SplashViewPager pager) {
	...
	@Override
	public void setViewPager(SplashViewPager pager, int initialPosition) {
		setViewPager(pager);
